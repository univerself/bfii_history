SELECT
    ...
    MAX(IIF(c.name = '100 вопросов', s.points, NULL)) AS "100 вопросов",
    MAX(IIF(c.name = 'Крестословица', s.points, NULL)) AS Крестословица,
    MAX(IIF(c.name = 'Игра слов', s.points, NULL)) AS "Игра слов",
    MAX(IIF(c.name = 'Эврика', s.points, NULL)) AS "Эврика",
